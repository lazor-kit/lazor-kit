...
/** WebAuthn RP ID used by the Lazor portal. */
const LAZOR_RP_ID = 'https://portal.lazor.sh';
...
export class LazorkitWalletAdapter extends BaseWalletAdapter {
    ...
    async sendTransaction(
        ...
        try {
            ...
            // Step 2: prepare execute context (challenge + finalize closure).
            ...
            try {
                ...
                const { instructions: finalizedIxs } = finalize({
                    signature,
                    authenticatorData,
                    clientDataJsonHash,
